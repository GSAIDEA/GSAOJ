    ...
    ?>
            <div class='row'>
              <div class='col-md-12 margin-bottom-20'>
                ...
                <p class='text-center'>
                  <?php echo $MSG_PROBLEM_TL.": ".$problem_data['time_limit']; ?>sec&nbsp;&nbsp;&nbsp;&nbsp;
                  <?php echo $MSG_PROBLEM_ML.": ".$problem_data['memory_limit']; ?>MB</p>
              </div>
              <div class='col-md-12 margin-bottom-30' id='hide_when_iframe_div'>
                <ul class='nav justify-content-center'>
                  <li class='nav-item'>
                    <a class='nav-link' href='./editor.php?id=<?php echo $request_id; ?>'>
                      <?php echo $MSG_SUBMIT; ?>
                    </a>
                  </li>
                  <li class='nav-item'>
                    <a class='nav-link' href='./status.php?pid=<?php echo $_GET['id']; ?>'>
                      <?php echo $MSG_STATUS; ?>
                    </a>
                  </li>
                  <li class='nav-item'>
                    <a class='nav-link' href='./problemrank.php?id=<?php echo $_GET['id']; ?>'>
                      <?php echo $MSG_RANK; ?>
                    </a>
                  </li>
                </ul>
              ...
              <div class='col-md-12 margin-bottom-50'>
                ...
                <hr>
                <p>
                  <?php echo $problem_data['description']; ?>
                </p>
              </div>
              <div class='col-md-12 margin-bottom-50'>
