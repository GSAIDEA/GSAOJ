...
?>
  ...
  <body>
    ...
    echo " active ";
}?>"><a class="page-link" href="rank.php">1</a></li>
              <?php
    ...
    if ($i == $request_page) {
        ...
        $temp_active = "";
                ...
                <li class="page-item<?php echo $temp_active; ?>">
                  <a class="page-link" href="rank.php?page=<?php echo $i; ?>">
                    <?php echo $i+1; ?>
                  </a>
                </li>
                <?php
          ...
          <table class='table table-sm'>
            <thead>
              <tr>
                ...
                <th>
                  <?php echo $MSG_RANKING_ID;?>
                </th>
                <th>
                  <?php echo $MSG_RANKING_SUBMIT;?>
                </th>
                <th>
                  <?php echo $MSG_RANKING_SOLVED;?>
                </th>
                <th>
                  <?php echo $MSG_RANKING_SANGME;?>
                </th>
                <th>
                  <?php echo $MSG_RANKING_SUCCESS_RATE;?>
                </th>
              </tr>
            </thead>
            <tbody>
...
while ($line = $res->fetch(PDO::FETCH_ASSOC)) {
    ...
    $uid=$getuid->fetch(PDO::FETCH_ASSOC); ?>
                  <th>
                    <a href='./userinfo.php?uid=<?php echo $uid['id']; ?>'>
                      <?php echo $line['userid']; ?>
                    </a>
                  </th>
                  <th>
                  ...
                  <th>
                    <?php echo $line['solved_once']; ?>
                  </th>
                  <th>
                    <?php echo htmlentities($line['sangme']); ?>
                  </th>
                  <th>
