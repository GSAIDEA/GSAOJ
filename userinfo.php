				...
				<div class="row">
					<div class="col-md-4">
						<table class="table table-sm">
							...
							<tr>
								<th>
									<?php echo $MSG_RANKING_SUBMIT; ?> </th>
								<td>
							...
							<tr>
								<th>
									<?php echo $MSG_INFO_EXPRESSION_ERROR; ?>
								</th>
								<td>
									<?php echo $line['exprerr']; ?>
								</td>
							</tr>
							<tr>
								<th>
									<?php echo $MSG_INFO_WRONG; ?>
								</th>
								<td>
									<?php echo $line['wrong']?>
								</td>
							...
							<tr>
								<th>
									<?php echo $MSG_INFO_RUNTIME_ERROR; ?>
								</th>
								<td>
									<?php echo $line['rterr']; ?>
								</td>
							...
							<tr>
								<th>
									<?php echo $MSG_INFO_COMPILE_ERROR; ?>
								</th>
								<td>
									<?php echo $line['cperr']; ?>
								</td>
