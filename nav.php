...
<?php if(!$auth->islogged()){ ?>
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href= "./login.php"><?php echo $MSG_LOGIN; ?></a>
                <a class="dropdown-item" href= "./register.php"><?php echo $MSG_CREATEACCOUNT; ?></a>
              </div>
<?php } else {?>
...
echo $id['userid'];?>
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href= "./mypage.php"><?php echo $MSG_ACCOUNTINFO; ?></a>
